...
public class Stage2State extends State {
    ...
    public Stage2State() {
        ...
        elements.add(new Balloon(10, 800, -10));
        elements.add(new Balloon(200, 900, -10));
        elements.add(new Balloon(300, 650, -10));
        elements.add(new Balloon(50, 400, -10));
        elements.add(new Balloon(10, 800, -10));
        elements.add(new Balloon(90, 500, -10));
